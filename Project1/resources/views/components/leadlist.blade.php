      ...
      <div class="page-header">
        <div class="page-block">
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">FixedColumns</li>
          </ul>
          <div class="page-header-title">
            <h2 class="mb-0">FixedColumns</h2>
          </div>
        </div>
      </div><!-- [ breadcrumb ] end -->
      <!-- [ Main Content ] start -->
      <div class="grid grid-cols-12 gap-6"><!-- prettier-ignore -->
        <div class="col-span-12 md:col-span-10 2xl:col-span-9 mb-5">
          <h5 class="mb-3">DataTables Extensions</h5>
          ...
          <div><a class="btn btn-sm btn-light-dark dark:text-white/50 rounded-full px-2" role="button" target="_blank"
              href="https://datatables.net/extensions/index"><i class="ti ti-external-link me-1"></i> Reference</a>
          </div>
        </div>
      </div>
      <div class="grid grid-cols-12 gap-6"><!-- Left And Right Fixed Columns start -->
        ...
        <div class="col-span-12 2xl:col-span-6">
          <div class="card">
            <div class="card-header">
              <h5>Right Fixed Column</h5><small>FixedColumns has the ability to freeze columns on both the left and the
                right hand sides of the table. By default it will fix the first column on the left, but using the
                initialization parameters</small>
            </div>
            <div class="card-body">
